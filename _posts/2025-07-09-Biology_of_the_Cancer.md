...
- `혈행성 전이`(hematogenous spread) : 혈관을 통해서 전이되는 것을 말한다. 예를 들어 colon(대장)에서 영양분을 흡수하고 나면 그것이 혈관을 통해 liver(간)으로 간다. 즉, colon에서 생긴 암은 혈행성 전이에 의해 liver로 전이될 수 있음을 말한다.
